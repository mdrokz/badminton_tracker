              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Icon(Icons.bookmark, color: white, size: 28),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Icon(Icons.favorite, color: white, size: 28),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Icon(Icons.share, color: white, size: 28),
                  ),
                ],
              ),
            ],
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: white, offset: Offset(0, 3)),
              ],
            ),
